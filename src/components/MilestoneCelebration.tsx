...
export function MilestoneCelebration({
  ...
  return (
    <div className="bg-gradient-to-r from-emerald-50 to-green-50 rounded-card p-6 border border-emerald-100 relative">
      <button
        onClick={handleDismiss}
        className="absolute top-4 right-4 p-1.5 text-emerald-400 hover:text-boon-success transition-colors"
        aria-label="Dismiss"
      >
      ...
      <div className="flex items-center gap-4">
        <div className="w-12 h-12 rounded-card bg-emerald-100 flex items-center justify-center flex-shrink-0">
        ...
        <div>
          ...
          <p className="text-sm text-boon-success mt-0.5">
            {messages[milestone]}
          </p>
        </div>
      </div>
