...
export default function PendingReflectionHome({
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8 md:space-y-12 animate-fade-in">
      ...
      <section className="bg-boon-blue/10 rounded-card p-8 md:p-10 border-2 border-boon-blue/20 shadow-lg">
        ...
        <h2 className="text-2xl md:text-3xl font-extrabold text-boon-navy mb-4">
        ...
        <button
          ...
          className="inline-flex items-center gap-3 px-8 py-4 text-lg font-bold rounded-card text-white bg-boon-blue hover:bg-boon-darkBlue transition-all shadow-lg shadow-boon-blue/20 active:scale-95"
        >
          Complete Reflection
          <span className="text-sm font-medium text-boon-lightBlue bg-white/20 px-2 py-0.5 rounded-btn">~3 min</span>
        </button>
      </section>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="flex items-center gap-3">
            <img
              ...
              alt="Coach"
              className="w-10 h-10 rounded-pill object-cover ring-2 ring-gray-100"
            />
            <div>
      ...
      <section className="bg-boon-offWhite rounded-card p-8 border border-boon-charcoal/[0.08]">
        <h3 className="text-sm font-bold text-boon-charcoal/55 uppercase tracking-[0.18em] mb-6">
          What you'll see after completing your reflection
        </h3>
        <div className="space-y-4">
          <div className="flex items-center gap-4">
            <div className="w-10 h-10 rounded-btn bg-boon-purple/10 flex items-center justify-center flex-shrink-0">
          ...
          <div className="flex items-center gap-4">
            <div className="w-10 h-10 rounded-btn bg-green-100 flex items-center justify-center flex-shrink-0">
              <svg className="w-5 h-5 text-boon-success" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="flex items-center gap-4">
            <div className="w-10 h-10 rounded-btn bg-boon-lightBlue flex items-center justify-center flex-shrink-0">
        ...
        {/* Preview hint */}
        {hasBaseline && (
          <div className="mt-6 pt-6 border-t border-boon-charcoal/[0.08]/50">
      ...
      {lastSession?.goals && (
        <section className="bg-gradient-to-br from-boon-blue/5 to-boon-lightBlue/20 rounded-card p-8 border border-boon-blue/10">
          <div className="flex items-start justify-between mb-4">
            <h2 className="text-xl font-extrabold text-boon-navy">Your Goals</h2>
