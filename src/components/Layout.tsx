...
export default function Layout({ children, currentView, setView, coachingState }: LayoutProps) {
  const { employee, signOut } = useAuth();

  const isCompleted = coachingState ? isAlumniState(coachingState.state) : false;

  // For completed users, hide "My Coach" page since relationship is paused
